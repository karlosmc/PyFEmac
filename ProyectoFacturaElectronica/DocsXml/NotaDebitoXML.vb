...
Public Class NotaDebitoXML
    ...
    Dim documento As DebitNote
    Public Function GenerarNotaDebito(Fact As DocumentoElectronico) As DebitNote
        documento = New DebitNote
        ...
        For Each DetalleDocumento As DetalleDocumento In Fact.Items
            ...
            documento.DebitNoteLines.Add(linea)
        Next
