...
Public Class Invoice
    ...
    Public Property AccountingCustomerParty As AccountingSupplierParty
        ...
        End Set
    End Property
    Public vInvoiceLines As List(Of InvoiceLine)
    Public Property InvoiceLines As List(Of InvoiceLine)
        Get
            Return vInvoiceLines
        End Get
    ...
    Public Sub New()
        ...
        InvoiceLines = New List(Of InvoiceLine)
    ...
    Public Sub WriteXml(writer As XmlWriter) Implements IXmlSerializable.WriteXml
        ...
        'writer.WriteElementString("cbc:ID", ext11.ID) '3    QUITADO 230418
        ...
        For Each AdditionalMonetaryTotal As AdditionalMonetaryTotal In ext1.AdditionalMonetaryTotals
            ...
            If AdditionalMonetaryTotal.Percent > 0 Then
                writer.WriteElementString("sac:Percent", AdditionalMonetaryTotal.Percent.ToString("#%"))
        ...
        writer.WriteStartElement("ext:UBLExtension") '2
        'writer.WriteElementString("cbc:ID", ext21.ID) QUITADO EL 230418
        ...
        Dim ext31 = UBLExtensions.Extension3
        Dim ext3 = UBLExtensions.Extension3.ExtensionContent.AdditionalInformation
        writer.WriteStartElement("ext:UBLExtension") '2.1

        'ExtensionContent
        writer.WriteStartElement("ext:ExtensionContent") '2.3
        If Not String.IsNullOrEmpty(ext3.SunatTransaction.Id) Then

            writer.WriteStartElement("sac:SUNATTransaction") '10
            '
            writer.WriteElementString("cbc:ID", ext3.SunatTransaction.Id)
            '
            writer.WriteEndElement() '10-
        ...
        For Each reference As InvoiceDocumentReference In DespatchDocumentReferences
        ...
        For Each reference As InvoiceDocumentReference In AdditionalDocumentReferences
        ...
        'add guias remision 26-08-2016
        'writer.WriteStartElement("cac:DespatchDocumentReference")
        'writer.WriteElementString("cbc:ID", DespatchDocumentReference.ID)
        'writer.WriteElementString("cbc:DocumentTypeCode", DespatchDocumentReference.DocumentTypeCode)
        'writer.WriteEndElement() '-------
        '----------------------------------------------------
        ...
        For Each InvoiceLine As InvoiceLine In InvoiceLines

            writer.WriteStartElement("cac:InvoiceLine") '5.1

            writer.WriteElementString("cbc:ID", InvoiceLine.ID.ToString())


            'InvoicedQuantity
            writer.WriteStartElement("cbc:InvoicedQuantity") '5.1.1
            ...
            For Each Item As AlternativeConditionPrice In InvoiceLine.PricingReference.AlternativeConditionPrices
            ...
            'AllowanceCharge
            'If InvoiceLine.AllowanceCharge.ChargeIndicator Then quitado para probar 0990198203810238103801823091803281099999999999999999999999999999999
            writer.WriteStartElement("cac:AllowanceCharge") '5.1.4

            writer.WriteElementString("cbc:ChargeIndicator", CStr(InvoiceLine.AllowanceCharge.ChargeIndicator.ToString).ToLower)
            ...
            '
            'Taxtotal
            For Each TaxTotal As TaxTotal In InvoiceLine.TaxTotals
