...
Public Class DebitNote
    ...
    Public vDebitNoteLines As List(Of InvoiceLine)
    Public Property DebitNoteLines As List(Of InvoiceLine)
        Get
            Return vDebitNoteLines
        End Get
        Set(value As List(Of InvoiceLine))
            vDebitNoteLines = value
        End Set
    End Property
    ...
    Public vRequestedMonetaryTotal As LegalMonetaryTotal
    Public Property RequestedMonetaryTotal As LegalMonetaryTotal
        Get
            Return vRequestedMonetaryTotal
        End Get
        Set(value As LegalMonetaryTotal)
            vRequestedMonetaryTotal = value
        End Set
    End Property
    ...
    Public Sub New()
        ...
        DebitNoteLines = New List(Of InvoiceLine)
    ...
    Public Sub WriteXml(writer As XmlWriter) Implements IXmlSerializable.WriteXml
        ...
        writer.WriteStartElement("cac:RequestedMonetaryTotal") '4
        ...
        writer.WriteValue(RequestedMonetaryTotal.PayableAmount.value.ToString(Constantes.FormatoNumerico, Formato))
        ...
        For Each debitNoteLine As InvoiceLine In DebitNoteLines

            writer.WriteStartElement("cac:DebitNoteLine") '5.1

            writer.WriteElementString("cbc:ID", debitNoteLine.ID.ToString())

            'InvoicedQuantity
            writer.WriteStartElement("cbc:DebitedQuantity") '5.1.1
            writer.WriteAttributeString("unitCode", debitNoteLine.DebitedQuantity.unitCode)
            writer.WriteValue(debitNoteLine.InvoicedQuantity.Value.ToString(Constantes.FormatoNumerico, Formato))
            ...
            writer.WriteValue(debitNoteLine.LineExtensionAmount.value.ToString(Constantes.FormatoNumerico, Formato))
            ...
            For Each Item As AlternativeConditionPrice In debitNoteLine.PricingReference.AlternativeConditionPrices
            ...
            'AllowanceCharge
            If debitNoteLine.AllowanceCharge.ChargeIndicator Then

                writer.WriteStartElement("cac:AllowanceCharge") '5.1.4

                writer.WriteElementString("cbc:ChargeIndicator", CStr(debitNoteLine.AllowanceCharge.ChargeIndicator.ToString).ToLower)
                ...
                writer.WriteValue(debitNoteLine.AllowanceCharge.Amount.value.ToString(Constantes.FormatoNumerico, Formato))
            ...
            '
            'Taxtotal
            For Each TaxTotal As TaxTotal In debitNoteLine.TaxTotals
            ...
            writer.WriteString(debitNoteLine.Price.PriceAmount.value.ToString(Constantes.FormatoNumerico, Formato))
